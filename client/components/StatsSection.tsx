  ...
  return (
    <section ref={ref} className="py-12 bg-[hsl(var(--background))]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="rounded-2xl px-4 py-8 sm:px-10 sm:py-12 bg-zinc-900/80 shadow-2xl border border-[hsl(var(--border))]">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 justify-center items-center w-full">
            {stats.map((s, i) => {
          ...
          initial={prefersReducedMotion ? { opacity: 1, y: 0 } : { opacity: 0, y: 16 }}
            ...
            transition={{ duration: 0.5, delay: i * 0.08 }}
                className="flex flex-col items-center justify-center gap-2 p-6 rounded-xl bg-gradient-to-b from-zinc-900/90 to-zinc-800/80 border border-zinc-800 shadow-lg hover:shadow-[0_8px_32px_rgba(183,28,45,0.10)] transition-all group w-full"
              >
